...
export default function Footer() {
    return (
        <footer className="Providers pt-20 pb-10 px-4 md:px-14 md:mt-[-5vw] mt-[-16vw]">
            <motion.div
            ...
            {/* Footer Bottom */ }
            <motion.div
                className="flex flex-col md:flex-row items-center justify-between bg-white p-5 rounded-3xl mt-6 gap-4 text-sm"
                variants={ container }
                initial="hidden"
                whileInView="show"
                viewport={ { once: true, amount: 0.3 } }
