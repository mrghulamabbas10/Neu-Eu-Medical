            ...
            >
                <motion.div className="grid grid-cols-1 lg:grid-cols-3 gap-8" variants={ containerVariants }>
                    <motion.div className="lg:col-span-2" variants={ itemVariants }>
                        <motion.h1 className="text-3xl md:text-4xl font-bold text-[#751010] mb-2" variants={ itemVariants }>
                            Shipping & Your Info
                        </motion.h1>
                        ...
                        <form onSubmit={ handleSubmit }>
                            <motion.div className="space-y-10" variants={ containerVariants }>
                                ...
                                <motion.div variants={ itemVariants }>
                                    <h2 className="text-2xl font-bold text-[#751010] mb-4">Shipping</h2>
                                ...
                                <motion.button
                                    type="submit"
                                    className="w-fit py-3.5 px-12 bg-[#b35c5c] text-white font-medium rounded-full  hover:bg-[#751010] transition-colors"
                    ...
                    {/* Order Summary */ }
                    <motion.div className="lg:col-span-1 bg-white rounded-xl overflow-hidden shadow-lg p-5" variants={ itemVariants }>
                        <motion.div
                            className=""
                            variants={ itemVariants }
                            whileHover={ { y: -5 } }
                        ...
                        >
                            ...
                            <div className="pt-5">
                                <h2 className="text-2xl font-bold text-[#751010] mb-2">Injectable GLP-1 Weight Loss Program</h2>
                                <p className="text-3xl font-bold text-[#751010] mb-6">$399</p>

                                <ul className="space-y-4 mb-6">
                                    <li className="flex items-start">
                                        <PiSealCheckFill className="text-[#751010] text-xl mr-2 mt-1 flex-shrink-0" />

                                        <span>Access to injectable GLP-1, a clinically proven medication for weight loss.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <PiSealCheckFill className="text-[#751010] text-xl mr-2 mt-1 flex-shrink-0" />
                                        <span>Personalized treatment plan developed by our medical team.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <PiSealCheckFill className="text-[#751010] text-xl mr-2 mt-1 flex-shrink-0" />
                                        <span>Regular virtual consultations to monitor progress.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <PiSealCheckFill className="text-[#751010] text-xl mr-2 mt-1 flex-shrink-0" />
                                        <span>Ongoing support to ensure safe and effective weight loss.</span>
                                    </li>
                                </ul>
                                ...
                                <div className="bg-[#f9f1ef] p-4 rounded-lg">
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b border-gray-200">
                                        <span className="text-sm font-medium">Semaglutide Weight Loss Program</span>
                                        <div className="flex justify-between w-1/2">
                                            <span>1</span>
                                            <span className="text-[#98423D] font-bold">$399.00</span>
                                        </div>
                                    </div>
