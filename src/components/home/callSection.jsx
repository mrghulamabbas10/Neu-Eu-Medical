...
export default function CallSection() {
  ...
  return (
    <div className="md:block hidden pt-32 pb-20 space-y-5 overflow-hidden calltoaction md:px-8 px-3" id="book">
      ...
      <Link  href="/eligibility" className="mt-10 relative z-10 mx-auto flex items-center justify-center px-8 border md:w-fit w-full border-primary text-primary font-semibold py-3 rounded-full hover:bg-primary hover:text-white transition">
