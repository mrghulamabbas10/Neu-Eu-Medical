...
export default function ContactUsPage() {
    ...
    return (
        ...
        >
            ...
            <span className="absolute top-[40%] left-[30%] blink"><Star /></span>

            <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                {/* Left Side */ }
                <motion.div variants={ containerVariants } initial="hidden" animate="show" className="md:space-y-10 space-y-6">
                    ...
                    <motion.div variants={ itemVariants } className="flex items-center space-x-4">
                        <div className="bg-white p-4 rounded"><MdOutlineCall className="text-[#891a1f] text-xl" /></div>
                        <div>
                    ...
                    <motion.div variants={ itemVariants } className="flex items-center space-x-4">
                        <div className="bg-white p-4 rounded"><HiOutlineMail className="text-[#891a1f] text-xl" /></div>
                        <div>
                    ...
                    <motion.div variants={ itemVariants } className="flex space-x-4 pt-4">
                        <Link href="" className="bg-white flex items-center justify-center px-6 py-2 rounded-md shadow hover:shadow-md">
                            <Image src="/images/facebook.png" alt="facebook" width={ 106 } height={ 30 } quality={ 100 } />
                        </Link>
                        <Link href="" className="bg-white px-6 py-2 rounded-md shadow hover:shadow-md">
                            <Image src="/images/instagram.png" alt="instagram" width={ 106 } height={ 30 } quality={ 100 } />
                        </Link>
                    </motion.div>
                </motion.div>
                ...
                >
                    { successMsg && <p className="text-center text-green-600 font-medium">{ successMsg }</p> }
                    ...
                    { ["name", "phone", "email", "message"].map((field) => {
                        ...
                        return (
                            <div key={ field } className="relative">
                                ...
                                { isTextarea ? (
                                    <textarea { ...inputProps } rows={ 5 } className={ inputProps.className + " resize-none" } />
                                ) : (
                                    <input type={ field === "email" ? "email" : "text" } { ...inputProps } />
                                ) }
